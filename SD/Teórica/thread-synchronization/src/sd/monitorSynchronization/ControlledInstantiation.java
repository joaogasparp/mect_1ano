package sd.monitorSynchronization;
...

{
   ...
   */
   ...
   public static synchronized ControlledInstantiation generateInst ()
   {
     while (n >= NMAX)
     { try
       { ( Class.forName ("sd.monitorSynchronization.ControlledInstantiation")).wait ();
       }
   ...
   */
   ...
   public static synchronized void releaseInst ()
   {
     n -= 1;
     try
     { (Class.forName ("sd.monitorSynchronization.ControlledInstantiation")).notify ();
     }
     catch (ClassNotFoundException e)
