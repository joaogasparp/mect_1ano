...
/**
 *    General description:
 *       definition of a FIFO memory of generic objects built in explicitly as a monitor using basic building blocks
 *       from the Java concurrency library.
...
public class MemFIFO<R> extends MemObject<R>
{
   ...
   */
   ...
   private Monitor mutex;                                  // mutual exclusion lock
   private ConditionVar fifoFull,                          // FIFO full condition variable
