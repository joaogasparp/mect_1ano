...
public class ThreadHierarchy1
{
  ...
  public static void main (String [] args)
  {
    ...
    Level1Thread [] l1Thr;                                             // array of level 1 threads
    ...
    { thrL1G[n] = new ThreadGroup (nTGBase + (n+1));
      ...
      l1Thr[n] = new Level1Thread (thrL1G[n], thrL2G[n], nTL1Base + (n+1), nL2, rps);
